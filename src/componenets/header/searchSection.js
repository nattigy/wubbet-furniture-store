...
import {faShoppingCart, faHeart, faBars, faSearch} from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="container-fluid bg-dark-custom">
            <div className="container-lg pb-4">
                <div className="row">
                    ...
                    <div className="col-lg-5 overflow-hidden px-0 pt-4">
                    ...
                    <div className="col-lg-4 text-right overflow-hidden">
                        <ul className="navbar-nav d-block text-nowrap pt-4">
                            ...
                            <li className="nav-item nav-inline mx-2">
                                <button className="text-white bg-transparent border-0 closebtn" onClick={() => props.openNav()}>
