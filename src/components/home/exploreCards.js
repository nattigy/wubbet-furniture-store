                ...
                <div className="col-md-4 col-xs-6">
                    <div className="shop">
                        ...
                        <div className="shop-body">
                            ...
                            <Link to="/category/HOME_FURNITURE"
                                  className="cta-btn">Shop now <FontAwesomeIcon icon={faArrowCircleRight}
                                                                                color="#fff"/></Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-md-4 col-xs-6">
                    <div className="shop">
                        ...
                        <div className="shop-body">
                            ...
                            <Link to="/category/COMMERCIAL_FURNITURE"
                                  className="cta-btn">Shop now <FontAwesomeIcon icon={faArrowCircleRight}
                                                                                color="#fff"/></Link>
                        </div>
                    </div>
                ...
                <div className="col-md-4 col-xs-6">
                    <div className="shop">
                        ...
                        <div className="shop-body">
                            ...
                            <Link to="/category/FINISHING_MATERIALS"
                                  className="cta-btn">Shop now <FontAwesomeIcon icon={faArrowCircleRight}
                                                                                color="#fff"/></Link>
                        </div>
                    </div>
